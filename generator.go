...
const localeTemplate = `// Code generated by currency_generator.go; DO NOT EDIT.
...
func ({{.Code}}) FormatInfo(locale locale.Locale) CurrencyFormatInfo {
...
func (g *Generator) generateLocales() error {
	...
	toIdentifier := func(code string) string {
